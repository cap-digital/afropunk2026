              ...
              return (
                ...
                >
                  <div className="flex items-center gap-2.5">
                    ...
                    />
                    <h3 className="marca shrink-0 text-[length:var(--fs-kpi)] leading-none">{c.nome}</h3>
                    ...
                    <span className="min-w-0 flex-1 truncate text-right text-[length:var(--fs-corpo)] text-[var(--ink-muted)]">
                      {c.conectado
                    ...
                    <span className="shrink-0 text-[length:var(--fs-kpi)] leading-none text-[var(--ink-muted)] transition-transform group-hover:translate-x-1">
                      →
                    </span>
                  </div>
