...
function BotaoPagina({
  ...
  return (
    <button
      ...
      aria-label={rotulo}
      className="flex h-7 w-7 items-center justify-center rounded-md border border-[var(--border-forte)] text-[14px] font-bold leading-none text-[var(--ink-2)] transition-colors hover:border-[var(--ink)] hover:text-[var(--ink)] disabled:opacity-30 disabled:hover:border-[var(--border-forte)] disabled:hover:text-[var(--ink-2)]"
    >
      {children}
    </button>
  );
